...
var score;  // Declare the variable

score = 100;  // Assign the value 100 to the variable

score = 200;  // Reassign the value 200 to the variable
 ...
 *    and press enter.
 *    200, the value assigned to score, should be displayed.
 *
